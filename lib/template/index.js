...
const template = {
    form: function (options, form) {
                ...
                case 'submit':
                    html += `<div class="form-group row text-right">
                        <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                            <button type="submit" class="btn btn-space btn-primary btn-lg" type="submit">${form[i].submit}</button>
        ...
        html += `</form>`;
        html += `<div class="be-spinner"><svg width="40px" height="40px" viewBox="0 0 66 66" xmlns="http://www.w3.org/2000/svg"><circle class="circle" fill="none" stroke-width="4" stroke-linecap="round" cx="33" cy="33" r="30"></circle></svg></div>`;
        html += `</div>`;
